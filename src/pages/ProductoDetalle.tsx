    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/">
            <Button className="bg-[#4513b8] hover:bg-[#360fa0]">Volver al inicio</Button>
          </Link>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-white pt-20 md:pt-24 pb-16">
      <div className="container mx-auto px-4">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-500 mb-4 md:mb-6 overflow-x-auto">
          <Link to="/" className="hover:text-[#4513b8] whitespace-nowrap">Inicio</Link>
          <ChevronRight className="w-4 h-4 shrink-0" />
          <Link to={`/categoria/${producto.categoria}`} className="hover:text-[#4513b8] capitalize whitespace-nowrap">
            {producto.categoria}
          </Link>
          <ChevronRight className="w-4 h-4 shrink-0" />
        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
            ...
            <div className="relative bg-gray-100 rounded-xl md:rounded-2xl overflow-hidden mb-3 md:mb-4">
              ...
              <div className="absolute top-3 left-3 md:top-4 md:left-4 flex flex-col gap-1 md:gap-2">
                ...
                {producto.etiquetas.includes('Nuevo') && (
                  <Badge className="bg-[#4513b8] text-white text-xs md:text-sm px-2 md:px-3 py-0.5 md:py-1">
                    Nuevo
                  </Badge>
                )}
              </div>
              ...
              <div className="absolute top-3 right-3 md:top-4 md:right-4 flex flex-col gap-1 md:gap-2">
                ...
                <button className="w-8 h-8 md:w-10 md:h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center text-gray-500 hover:text-[#4513b8] transition-colors shadow-sm">
          ...
          >
            ...
            <div className="flex items-end gap-2 md:gap-4 mb-4 md:mb-6">
              <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#4513b8]">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mb-6 md:mb-8">
              ...
              <Button
                size="lg"
                className="flex-1 bg-[#4513b8] hover:bg-[#360fa0] text-base md:text-lg font-semibold"
            ...
            <div className="grid grid-cols-2 gap-2 md:gap-4">
              <div className="flex items-center gap-2 md:gap-3 p-2 md:p-4 bg-gray-50 rounded-lg md:rounded-xl">
                <Truck className="w-5 h-5 md:w-6 md:h-6 text-[#4513b8]" />
                <div>
              ...
              <div className="flex items-center gap-2 md:gap-3 p-2 md:p-4 bg-gray-50 rounded-lg md:rounded-xl">
                <Shield className="w-5 h-5 md:w-6 md:h-6 text-[#4513b8]" />
                <div>
              ...
              <div className="flex items-center gap-2 md:gap-3 p-2 md:p-4 bg-gray-50 rounded-lg md:rounded-xl">
                <RotateCcw className="w-5 h-5 md:w-6 md:h-6 text-[#4513b8]" />
                <div>
              ...
              <div className="flex items-center gap-2 md:gap-3 p-2 md:p-4 bg-gray-50 rounded-lg md:rounded-xl">
                <Check className="w-5 h-5 md:w-6 md:h-6 text-[#4513b8]" />
                <div>
        ...
        <Tabs defaultValue="especificaciones" className="mb-12 md:mb-16">
          <TabsList className="bg-gray-100 border-b border-gray-200 w-full justify-start rounded-none p-0 overflow-x-auto">
            <TabsTrigger
              ...
              className="data-[state=active]:bg-white data-[state=active]:text-[#4513b8] rounded-none px-4 md:px-6 py-2 md:py-3 text-sm md:text-base whitespace-nowrap"
            >
              Especificaciones
            </TabsTrigger>
            <TabsTrigger
            ...
            <div className="bg-gray-50 rounded-xl md:rounded-2xl p-4 md:p-6">
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="w-8 h-8 md:w-10 md:h-10 bg-[#4513b8]/10 rounded-lg flex items-center justify-center shrink-0">
                    <Truck className="w-4 h-4 md:w-5 md:h-5 text-[#4513b8]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="w-8 h-8 md:w-10 md:h-10 bg-[#4513b8]/10 rounded-lg flex items-center justify-center shrink-0">
                    <Check className="w-4 h-4 md:w-5 md:h-5 text-[#4513b8]" />
                  </div>
                  <div>
...
function ProductoRelacionadoCard({ producto }: { producto: Producto }) {
  ...
  return (
    <Link to={`/producto/${producto.id}`}>
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden group hover:border-[#4513b8] hover:shadow-lg transition-all">
        ...
        <div className="p-3 md:p-4">
          <h3 className="font-medium text-gray-900 text-sm md:text-base line-clamp-2 mb-1 md:mb-2 group-hover:text-[#4513b8] transition-colors">
            {producto.nombre}
          </h3>
          <p className="text-base md:text-lg font-bold text-[#4513b8]">{formatPrice(producto.precio)}</p>
        </div>
      </div>
    </Link>
  );
