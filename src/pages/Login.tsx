      ...
      <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-6 md:gap-8">
        ...
        >
          <Link to="/" className="flex items-center gap-2 mb-6 md:mb-8">
            <div className="w-12 h-12 bg-[#4513b8] rounded-xl flex items-center justify-center">
              <span className="text-white font-bold text-2xl">L</span>
            </div>
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Loperzaik</h1>
              <p className="text-sm text-[#4513b8]">Tecnología de Vanguardia</p>
            </div>
          </Link>
          ...
          <div className="space-y-3 md:space-y-4">
            {[
              ...
              <div key={index} className="flex items-center gap-3">
                <div className="w-5 h-5 md:w-6 md:h-6 bg-[#4513b8]/10 rounded-full flex items-center justify-center">
                  <Check className="w-3 h-3 md:w-4 md:h-4 text-[#4513b8]" />
                </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5 md:p-8 shadow-lg">
            ...
            <div className="lg:hidden flex justify-center mb-4 md:mb-6">
              <Link to="/" className="flex items-center gap-2">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-[#4513b8] rounded-xl flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#4513b8]">Tecnología de Vanguardia</p>
                </div>
              </Link>
            </div>
            ...
            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-gray-100 mb-4 md:mb-6">
                <TabsTrigger value="login" className="data-[state=active]:bg-white data-[state=active]:text-[#4513b8] text-sm md:text-base">
                  Iniciar sesión
                </TabsTrigger>
                <TabsTrigger value="register" className="data-[state=active]:bg-white data-[state=active]:text-[#4513b8] text-sm md:text-base">
                  Crear cuenta
                </TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="login">
                <form onSubmit={handleLogin} className="space-y-3 md:space-y-4">
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-[#4513b8] hover:bg-[#360fa0] text-sm md:text-base"
                    disabled={isLoading}
                  >
                    {isLoading ? (
                ...
                <form onSubmit={handleRegister} className="space-y-3 md:space-y-4">
                  ...
                  <label className="flex items-start gap-2 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-600">
                      Acepto los{' '}
                      <Link to="/terminos" className="text-[#4513b8] hover:text-[#360fa0]">
                        términos y condiciones
                      </Link>{' '}
                      y la{' '}
                      <Link to="/privacidad" className="text-[#4513b8] hover:text-[#360fa0]">
